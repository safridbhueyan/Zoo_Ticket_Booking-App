...
class FieldtripScreen extends StatelessWidget {
  const FieldtripScreen({super.key});
                  ...
                  children: [
                    GlassContainer(
                      ...
                      child: Column(
                        children: [
                          PackageContainer(
                            title: "Basic Field Trips Package",
                            discription:
                          ...
                          SizedBox(height: 8.h),
                          PackageContainer(
                            title: "Deluxe Field Trips Package",
                            discription:
                                "Up to 15 guests, 1 party host, reserved picnic area, standard décor, animal encounter, cupcakes",
